...
export const fr: EnDict = {
  ...
  editor: {
    ...
    tile: {
      ...
      badge_solar: 'Badge : Suivi solaire',
      badge_force: 'Badge : Dérogation forcée',
      badge_weather: 'Badge : Sécurité météo',
      badge_manual: 'Badge : Dérogation manuelle',
      badge_custom_position: 'Badge : Position personnalisée',
      badge_motion: 'Badge : Mouvement',
      badge_climate: 'Badge : Climatique',
      badge_glare_zone: "Badge : Zone d'éblouissement",
      badge_cloud: 'Badge : Suppression nuageuse',
