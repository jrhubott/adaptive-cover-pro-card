// French translations. Currently mirrors EN values as placeholders.
// Translation review/fill in progress (see PR opened against this branch).
// Do NOT rename or restructure keys here without changing en.ts — TypeScript enforces shape parity.
