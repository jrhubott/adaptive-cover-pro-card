...
export const fr: EnDict = {
  ...
  dialog: {
    ...
    floor_tooltip: 'Plancher — le créneau élève la position au-dessus du calcul brut',
    floor: 'plancher',
  ...
  compass: {
    ...
    in_fov_check: '✓ dans le FOV',
    in_fov: 'dans le FOV',
    none: '—',
    sun: 'Soleil',
    moon: 'Lune',
    sun_hitting: 'Soleil (frappe la fenêtre)',
    sun_in_fov_invalid: 'Soleil (dans le FOV, non valide)',
    sun_outside_fov: 'Soleil (hors du FOV)',
    window_fov: 'FOV fenêtre',
    sun_path: 'Trajectoire solaire',
    sunrise: 'Lever du soleil',
    sunset: 'Coucher du soleil',
    cover_closed: 'Store fermé',
    window_normal: 'Normale de fenêtre',
    stat_sun: 'Soleil : ',
    stat_azi: 'Azi : ',
    stat_elev: 'Élév : ',
    stat_window: 'Fenêtre : ',
    active_sun_arc: 'Arc solaire actif {from} – {to}{elev}',
    fov_arc: 'FOV {left} gauche / {right} droite{elev}',
    window_normal_tooltip: 'Normale de fenêtre : {bearing}',
    cover_extended: 'Store déployé : {pct}%',
    cover_closed_tooltip: 'Store fermé : {pct}%',
    blind_spot: 'Angle mort : {from} – {to}',
  ...
  elevation: {
    ...
    no_fov_today: "Le soleil n'entre pas dans le FOV aujourd'hui",
  ...
  editor: {
    ...
    main: {
      ...
      section_sky_desc: 'Soleil par rapport au FOV de la fenêtre, tracé polaire',
    ...
    tile: {
      ...
      resume_option_auto: 'Auto (dérogation manuelle ou position personnalisée)',
      resume_option_always: 'Toujours (quand le bouton de réinitialisation est disponible)',
      resume_option_never: 'Jamais',
    ...
    compass: {
      ...
      toggle_legend_desc: "Échantillons de couleur + étiquettes d'instance sous la boussole.",
      ...
      toggle_blind_spot_label: 'Angles morts',
      toggle_blind_spot_desc: 'Secteurs hachurés pour la plage aveugle de chaque fenêtre.',
