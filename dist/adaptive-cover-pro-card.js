    ...
    `}_renderEntryLayers(e,t,o=0,s=[]){const i=We(e.sun.window_azimuth),n=We(i-e.sun.fov_left),r=We(i+e.sun.fov_right),a=this._readActiveAzimuth(e.d.entities.start_sensor),l=this._readActiveAzimuth(e.d.entities.end_sensor),c=null!==a&&null!==l;let d,h;if(c)({wedgeStart:d,wedgeEnd:h}=function(e,t,o,s,i){const n=((o-s)%360+360)%360,r=s+i,a=((t-n)%360+360)%360,l=e=>e<=r?e:e-r<360-e?r:0,c=l(((e-n)%360+360)%360),d=l(a);return c===d?{wedgeStart:n,wedgeEnd:((n+r)%360+360)%360}:{wedgeStart:((n+Math.min(c,d))%360+360)%360,wedgeEnd:((n+Math.max(c,d))%360+360)%360}}(We(a),We(l),i,e.sun.fov_left,e.sun.fov_right));else{const t=function(e,t,o,s,i){if(void 0===i)return null;const n=We(t-o),r=o+s,a=e.filter(e=>((e.azimuth-n)%360+360)%360<=r&&e.elevation>i);return 0===a.length?null:{wedgeStart:a[0].azimuth,wedgeEnd:a[a.length-1].azimuth}}(s,i,e.sun.fov_left,e.sun.fov_right,e.sun.min_elevation);d=t?t.wedgeStart:n,h=t?t.wedgeEnd:r}const p=Ue(i,xt,o),{outer:u,inner:_}=(g=e.sun.min_elevation,m=e.sun.max_elevation,f=xt,void 0!==g&&void 0!==m&&g>m?{outer:f,inner:0}:{outer:void 0!==g?f*He(g):f,inner:void 0!==m?f*He(m):0});var g,m,f;const v="cover_awning"===e.coverType?e.coverPos/100:1-e.coverPos/100,y=null!==e.coverPos?xt*v:null,b=null!==y?Math.min(y,u):null,$=e.sun.blind_spot_range?[We((w=i)-(x=e.sun.blind_spot_range)[1]),We(w-x[0])]:null;var w,x;const k=$?qe($[0],$[1],xt,0,o):null,C=qe(d,h,u,_,o),S=c&&(d!==n||h!==r),A=S?qe(n,r,u,_,o):"",E=null!==b&&b>_?qe(d,h,b,_,o):"",z=[];for(const t of _t(s,i,e.sun.fov_left,e.sun.fov_right)){const i=Ve(s,t.startIdx,t.endIdx,e.sun.min_elevation);i&&!Ge(i.wedgeStart,i.wedgeEnd,d,h)&&z.push({fov:qe(i.wedgeStart,i.wedgeEnd,u,_,o),cover:this.showCoverFill&&null!==b&&b>_?qe(i.wedgeStart,i.wedgeEnd,b,_,o):"",from:i.wedgeStart,to:i.wedgeEnd})}const P=t?`${e.d.entry_title}: `:"",O=void 0!==e.sun.min_elevation||void 0!==e.sun.max_elevation?Le("compass.elev_suffix",this.hass,{min:vt(e.sun.min_elevation??0),max:vt(e.sun.max_elevation??90)}):"",M=c?`${P}${Le("compass.active_sun_arc",this.hass,{from:vt(d),to:vt(h),elev:O})}`:`${P}${Le("compass.fov_arc",this.hass,{left:vt(e.sun.fov_left),right:vt(e.sun.fov_right),elev:O})}`,T=`${P}${Le("compass.window_normal_tooltip",this.hass,{bearing:vt(i)})}`,I=null!==e.coverPos?"cover_awning"===e.coverType?`${P}${Le("compass.cover_extended",this.hass,{pct:e.coverPos})}`:`${P}${Le("compass.cover_closed_tooltip",this.hass,{pct:e.coverPos})}`:"",F=$?`${P}${Le("compass.blind_spot",this.hass,{from:vt($[0]),to:vt($[1])})}`:"",N=t||e.isOverride,R=N?`fill: ${e.color}; stroke: ${e.color};`:"",D=N?`fill: ${e.color}; stroke: ${e.color};`:"",L=N?`fill: ${e.color}; stroke: ${e.color};`:"",j=N?`stroke: ${e.color};`:"",U=N?`fill: ${e.color};`:"",H=this.showCoverFill&&""!==E,q=this.showBlindSpot&&!!k,B=this.showWindowArrow,V=`M 0 0 L ${p.x} ${p.y}`,G="display: none;",Z=`${P}${Le("compass.fov_arc",this.hass,{left:vt(e.sun.fov_left),right:vt(e.sun.fov_right),elev:O})}`;return W`<g class="entry-overlay">
      ...
      ${this.showWindowArrow?B`<div>
        ...
        <div class="stats dim">
          <div class="stats-row">
            <span
              >${Le("compass.stat_sun",this.hass)}${vt(s)} /
              ${vt(i)}</span
            >
      ...
      <span>${Le("compass.stat_azi",this.hass)}${vt(s)}</span>
      <span>${Le("compass.stat_elev",this.hass)}${vt(i)}</span>
      ...
      <div class="backdrop" data-open @click=${this._onBackdrop}>
        <div class="dialog" @click=${this._stop} role="dialog" aria-modal="true">
          ...
          <div class="position-block">
            ...
            <div class="position-value">${ft(i)}</div>
