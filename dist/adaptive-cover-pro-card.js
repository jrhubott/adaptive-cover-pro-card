      ...
      <div class="compass">
        <svg viewBox="${-140} ${-140} ${280} ${280}">
          ${V`
            ...
            ${this.showSunriseSunset&&x&&null!==b?V`<g data-tooltip=${O}><title>${O}</title><circle class="rise-marker" cx=${x.x} cy=${x.y} r="4"></circle></g>`:Z}
            ${this.showSunriseSunset&&k&&null!==w?V`<g data-tooltip=${P}><title>${P}</title><circle class="set-marker" cx=${k.x} cy=${k.y} r="4"></circle></g>`:Z}
