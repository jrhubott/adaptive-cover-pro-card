  ...
  `,e([ge({attribute:!1})],Hs.prototype,"hass",void 0),e([ge({attribute:!1})],Hs.prototype,"position",void 0),e([ge({attribute:!1})],Hs.prototype,"deviceClass",void 0),e([ge({type:Boolean})],Hs.prototype,"enabled",void 0),e([ge()],Hs.prototype,"labels",void 0),e([ge({type:Boolean,reflect:!0})],Hs.prototype,"compact",void 0),e([ge({type:Boolean,reflect:!0})],Hs.prototype,"fill",void 0),Hs=e([pe("acp-cover-move-buttons")],Hs);const Us={all:"mdi:robot",some:"mdi:robot-outline",none:"mdi:robot-off"};let qs=class extends de{constructor(){super(...arguments),this.showSceneSelect=!0,this.showLock=!0,this.showAutomation=!0,this.showClearOverrides=!0}render(){if(!this.hass||!this.discovered||!this.snapshot)return V;const e=this.snapshot,t=this.showClearOverrides?e.clearId:void 0,o=this.showLock&&!!e.lockId,i=this.showAutomation&&!!e.automationId,s=this.showSceneSelect&&!!this.discovered.entities.group_scene_select;if(!(s||o||i||t))return V;const n=function(e){if(!e)return!0;const t=Object.values(e);return 0!==t.length&&t.some(e=>!e||Os.has(Ei(e)))}(e.memberWinners);return H`
      <div class="group-row" @click=${this._stop} @pointerdown=${this._stop} @keydown=${this._stop}>
        ...
        ${t?H`<button
              ...
              ?disabled=${!n}
              ${So(st(n?"group.clear_overrides":"group.clear_overrides_none",this.hass))}
