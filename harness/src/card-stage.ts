...
export class AcpHarnessCardStage extends LitElement {
  ...
  private _tileConfig(entryId: string): Record<string, unknown> {
    ...
    return {
      ...
      show_position_bar: t.show_position_bar,
      show_tilt: t.show_tilt,
      ...(t.covers?.length ? { covers: t.covers } : {}),
      ...(t.controls_cover ? { controls_cover: t.controls_cover } : {}),
      ...(t.controls_axis ? { controls_axis: t.controls_axis } : {}),
      show_scene_select: t.show_scene_select,
      show_lock: t.show_lock,
      show_automation: t.show_automation,
      show_climate: t.show_climate,
